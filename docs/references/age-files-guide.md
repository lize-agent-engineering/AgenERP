...
Install already replaced `AgenERP` placeholders. Verify the substitution, then leave alone (or replace `AGENTS.md` with your own contract — many projects do).
...
| `docs/index.md` | WI5 | Verify no `AgenERP` residue; fill remaining route placeholders. |
